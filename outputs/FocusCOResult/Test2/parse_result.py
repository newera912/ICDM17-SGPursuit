...
def main():
    output=open("../../result/VaryingNumOfClusters-FocusCO_0.9.txt","w")
    for clusterNum in [10,12,14,15,20,25]:
        file_name = 'VaryingNumOfClusters_APDM_Dense_subgraph_in_0.35_out_0.1_numClusters_' + str(clusterNum) + '_TrueSGSize_30_FeasNum_100_trueFeasNum_10_sigmas1_0.0316_0.9.txt'
        data = dict()
