...
public class FastPCST {
    ...
    public static void main(String args[]) {
        ...
        PruningMethod pruningMethod = PruningMethod.kStrongPruning;
        int verbostiy_level = 0;
        FastPCST fastPCST = new FastPCST(edges, prizes, costs, root, target_num_active_clusters, pruningMethod, verbostiy_level);
