...
public class HeadApprox {
     ...
     * @param C
     */
    public HeadApprox(ArrayList<Integer[]> edges, ArrayList<Double> c, ArrayList<Double> pi, int g, double C, boolean debug) {
    ...
    public HeadApprox(ArrayList<Integer[]> edges, ArrayList<Double> edgeCostsW, double[] b, int s, int g, double B, boolean debug) {
        this(edges, edgeCostsW, b, s, g, B, null, debug);
    }
